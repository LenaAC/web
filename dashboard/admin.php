...
<?php if ($_SESSION['discord']['user-id'] === '706685677877723137' && $_SESSION['discord']['user-id'] === '706685677877723137' ) { ?>
  ...
  <body>
  	...
  	<div class="container" style="padding-top:100px;">
        ...
        <br>
        <a href="#" style="font-size: 12px; text-decoration: none;"><span class="bcus" style="border: 1px solid #ff00c4; border-radius: 3px; padding: 2px;"><i class="fa fa-history"></i> IP Logs</span></a><br><br><a href="//i.mythologic.al/u/" style="font-size: 12px; text-decoration: none;"><span class="bcus" style="border: 1px solid #ff00c4; border-radius: 3px; padding: 2px;"><i class="fa fa-picture-o"></i> Screenshots</span></a><br><br><a href="#" style="font-size: 12px; text-decoration: none;"><span class="bcus" style="border: 1px solid #ff00c4; border-radius: 3px; padding: 2px;"><i class="fa fa-database"></i> Secure Database</span></a><br><br><a href="//mail.charon.gg" style="font-size: 12px; text-decoration: none;"><span class="bcus" style="border: 1px solid #ff00c4; border-radius: 3px; padding: 2px;"><i class="fa fa-envelope"></i> Mail</span></a>
  			<br><br>
