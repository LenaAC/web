...
<?php if ($_SESSION['discord']['user-id'] === '706685677877723137' && $_SESSION['discord']['user-id'] === '706685677877723137' ) { ?>
  ...
  <body>
  	...
  	<div class="container" style="padding-top:100px;">
        ...
        <br>
        <a href="#" style="font-size: 17px; text-decoration: none;"><span style="border: 1px solid #fff; border-radius: 4px; padding: 3px;">IP Logs</span></a><br style="padding: 6px;"><a href="#" style="font-size: 17px; text-decoration: none;"><span style="border: 1px solid #fff; border-radius: 4px; padding: 3px;">Screenshots</span></a><br style="padding: 6px;"><a href="#" style="font-size: 17px; text-decoration: none;"><span style="border: 1px solid #fff; border-radius: 4px; padding: 3px;">Secure Database</span></a>
  			<br><br>
