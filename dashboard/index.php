    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
         ...
         &nbsp;<li>&nbsp;<button type="button" id="pfp" onclick="window.location.href='https://charon.gg/'" class="btn btn-default navbar-btn" style="background: url(https://cdn.discordapp.com/avatars/<?php echo $_SESSION['discord']['user-id'];?>/<?php echo $_SESSION['discord']['avatar-id'];?>.png); background-size: cover; background-repeat: no-repeat; background-position: 50% 50%;"><i class="fa fa-picture-o" style="opacity: 10%;"></i></button></li>
         <li><button id="userinfo" type="button" onclick="window.location.href='/'" class="btn btn-default navbar-btn"><i class="fa fa-user" style="opacity: 60%;"></i> <?php echo $_SESSION['discord']['username'];?>#<?php echo $_SESSION['discord']['discriminator'];?></li>
         <li><form method="post"><input style="display: none;" id="message" type="text" name="message"><button onClick="window.open('whitelist','windowname','width=600,height=600')" id="submit" class="btn btn-default navbar-btn" type="submit"><i style="color: #fff;" class="fa fa-plus"></i></a></form></button></li>
         <li>&nbsp;<button type="button" onclick="window.location.href='logout'" class="btn btn-default navbar-btn"><i class="fa fa-sign-out"></i> Logout</button></li></ul>
</div>
</div>
</nav>
</body>
...
<script>
document.getElementById("userinfo").setAttribute("disabled", "disabled");
</script>
