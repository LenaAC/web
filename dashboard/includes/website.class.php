...
class website {
   ...
   */
   public static function discord_auth_redirect($client_id, $scopes) {
      self::website_redirect('https://discord.com/api/oauth2/authorize?' . http_build_query(array(
         'response_type' => 'code',
         'client_id'     => $client_id,
         'scope'         => $scopes
      )));
   ...
   public static function discord_auth($client_id, $client_secret, $scopes, $code) {
      $request = self::http_request('https://discord.com/api/oauth2/token', http_build_query(array(
   ...
   public static function discord_user_info($token) {
      $request = self::http_request('https://discord.com/api/users/@me', false, array(
