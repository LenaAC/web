    ...
    <body>
        <div class="container">
            ...
            <div class="error-icon">
               <a target="_blank" href="//dashboard.charon.gg"><img style="margin: 15px; width: 100%; height: 100%; border: 1px solid #ff00c4; border-right: 3px solid #ff00c4; border-left: 3px solid #ff00c4; border-bottom: 8px solid #ff00c4; border-top: 8px solid #ff00c4;" src="https://cdn.discordapp.com/avatars/<?php echo $_SESSION['discord']['user-id'];?>/<?php echo $_SESSION['discord']['avatar-id'];?>.png">
            </div>
